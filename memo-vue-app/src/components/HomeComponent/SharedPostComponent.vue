          ...
          <div class="card-body">
            ...
            <div v-if="post_page.has_media" class="media_container">
              <div class="media_one" v-if="post_page.media.length === 1">
                <img
                  v-if="post_page.media[0].mime_type.includes('image')"
                  :src="post_page.media[0].url"
                  alt=""
                />
              ...
              >
                ...
                <div class="media_two_box">
                  <img
                    v-if="post_page.media[1].mime_type.includes('image')"
                    :src="post_page.media[1].url"
                    alt=""
                  />
              ...
              <div class="media_three" v-if="post_page.media.length === 3">
                ...
                <div class="media_three_box_under">
                  <img
                    v-if="post_page.media[2].mime_type.includes('image')"
                    :src="post_page.media[2].url"
                    alt=""
                  />
              ...
              <div class="media_four" v-if="post_page.media.length === 4">
                ...
                <div class="media_four_box">
                  <img
                    v-if="post_page.media[3].mime_type.includes('image')"
                    :src="post_page.media[3].url"
                    alt=""
                  />
