      ...
      <div class="card card_skelton">
        ...
        >
            <div class="d-flex align-items-center">
                <div v-if="user.has_media_profile === false" class="img skeleton_animation">
                    
                </div>
                <img class="img" v-else-if="user.media[0].collection_name === 'profile'" :src="user.media[0].src_url" alt="" />
                <img class="img" v-else-if="user.media[1].collection_name === 'profile'" :src="user.media[1].src_url" alt="" />
                <div class="ms-3">
                    <p class="mb-0 " >
