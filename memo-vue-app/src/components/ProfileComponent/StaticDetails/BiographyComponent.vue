    ...
    <ul>
      ...
      <div>
        <h6
          ...
          v-if="this.profile_details[2].details.value == null"
        >
        ...
        <div class="input-job" v-if="addBiography">
          ...
          <div class="form-group">
            <button
              ...
              :disabled="
                !this.formBiography.value || !this.formBiography.privacy
              "
            >
              {{ $t("Save") }}
            </button>
        ...
        <div class="input-job" dir="auto" v-if="updateBiography">
          ...
          <div dir="auto" class="vcomments__add-block">
            <textarea
              ...
              :value="this.profile_details[2].details.value"
              ref="textarea"
            ></textarea>
          </div>
          <div class="vcomments__add-block">
            <label for="display_in_profile" class="vcomments__add-input"
              ...
              >
                <option
                  :selected="this.profile_details[2].details.status === 1"
                  value="1"
                >
                  {{ $t("Yes") }}
                </option>
                <option
                  :selected="this.profile_details[2].details.status === 0"
                  value="0"
                >
                  {{ $t("No") }}
                </option>
          ...
          <div class="vcomments__add-block">
            ...
            >
              <option value="" disabled>Choose privacy...</option>
              <option
                :selected="this.profile_details[2].details.privacy === 'public'"
                value="public"
              >
                {{ $t("public") }}
              </option>
              <option
                :selected="
                  this.profile_details[2].details.privacy === 'friends'
                "
                value="friends"
              >
                {{ $t("friends") }}
              ...
              <option
                :selected="
                  this.profile_details[2].details.privacy === 'just_me'
                "
                value="just_me"
              >
                {{ $t("just me") }}
              ...
              <option
                :selected="
                  this.profile_details[2].details.privacy === 'specific_friends'
                "
              ...
              <option
                :selected="
                  this.profile_details[2].details.privacy ===
                  'all_friends_except'
                "
