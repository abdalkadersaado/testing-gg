          ...
          <div class="d-flex align-items-center">
            <div>
              ...
              <img
                class="page-profile"
                v-else-if="
                  pagedetail.media[0].collection_name.includes('pages_profiles')
                "
                :src="pagedetail.media[0].thumb"
                alt=""
              />
              <img
                class="page-profile"
                v-else-if="
                  pagedetail.media[1].collection_name.includes('pages_profiles')
                "
                :src="pagedetail.media[1].thumb"
                alt=""
              />
            </div>
            <div class="ms-3">
        ...
        <div class="card-body">
          ...
          <div v-if="post.has_media" class="media_container">
            <div class="media_one" v-if="post.media.length === 1">
              <img
                v-if="post.media[0].mime_type.includes('image')"
            ...
            >
              ...
              <div class="media_two_box">
                <img
                  v-if="post.media[1].mime_type.includes('image')"
            ...
            <div class="media_three" v-if="post.media.length === 3">
              ...
              <div class="media_three_box_under">
                <img
                  v-if="post.media[2].mime_type.includes('image')"
            ...
            <div class="media_four" v-if="post.media.length === 4">
              ...
              <div class="media_four_box">
                <img
                  v-if="post.media[3].mime_type.includes('image')"
          ...
          <div v-if="post.sharing_post_page != false" class="shared">
            <SharedPostComponent
              v-if="post.shared_post_page.post"
              :post="post.shared_post_page.post"
            />
            <SharedPostComponent
              v-if="post.shared_post_page.post_page"
              :post_page="post.shared_post_page.post_page"
            />
          </div>
          <div
